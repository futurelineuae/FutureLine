...
@section('content')
                ...
                <div class="page_content_wrap scheme_default">
                    <div class="content_wrap">
                        <!-- Content -->
                        <div class="content">
                            <article class="post_item_single post_format_audio format-audio">
                                <div class="post_content">
                                    ...
                                    <audio class="tpl-audio-shortcode" preload="none" style="width: 100%;" controls="controls">
                                        <source type="audio/mpeg" src="media/sample-melody.mp3" />
                                        <a href="media/sample-melody.mp3">media/sample-melody.mp3</a>
                                    </audio>
