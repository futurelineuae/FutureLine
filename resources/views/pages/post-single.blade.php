                        ...
                        <div class="content">
                            <article class="post_item_single">
                                <div class="post_featured">
                                    <img src="http://placehold.it/1170x658" alt="" />
                                </div>
                                <!-- Post Content -->
                                        ...
                                        <div class="post_meta_item post_share">
                                            <div class="socials_wrap socials_share socials_size_tiny socials_type_block socials_dir_horizontal">
                                                <span class="social_items">
                                                    ...
                                                    <span class="social_item social_item_popup">
                                                        <a href="#" class="social_icons social_tumblr">
                                                            <span class="trx_addons_icon-tumblr"></span>
                                                        </a>
                                                    </span>
                                                    <span class="social_item social_item_popup">
                                                        <a href="#" class="social_icons social_mail">
                                ...
                                <!-- /Post Content -->
                                <!-- Author Info -->
                                <div class="author_info author">
                                    <div class="author_avatar">
                                        <img alt="" src="http://2.gravatar.com/avatar/e64c7d89f26bd1972efa854d13d7dd61?s=120&#038;d=mm&#038;r=g" /> </div>
                                    <!-- .author_avatar -->
                                    <div class="author_description">
                                        <div class="author_subtitle">About</div>
                                        <h5 class="author_title">Kathleen Swanson</h5>
                                        <div class="author_bio">
                                            <p>Trying my suit on for the first time was a really special moment. How it felt to wear and how it made me eel was amazing.</p>
                                    ...
                                    <div class="nav-links">
                                        <div class="nav-previous">
                                            <a href="post-single.html">
                                                ...
                                                <h6 class="post-title">Tips for Collecting Quality Feedbacks from Your Clients</h6>
                                                <span class="post_date">September 4, 2016</span></a>
                                        </div>
                                        <div class="nav-next">
                                            <a href="post-single.html">
                                                <span class="nav-arrow"></span>
                                                <h6 class="post-title">Creative Spotlight: 6 Steps to Increase Your Pace</h6>
                                                <span class="post_date">September 22, 2016</span>
                                            </a>
                                        </div>
                                    </div>
                                </nav>
                                ...
                                <div class="columns_wrap posts_container">
                                    <div class="column-1_2">
                                        <div class="related_item related_item_style_2">
                                            <div class="post_featured hover_icon copypress-post-related-post-1">
                                                <div class="mask"></div>
                                                <div class="icons">
                                            ...
                                            <div class="post_header">
                                                <span class="post_date">
                                                    <a href="post-single.html">27.11.2016</a>
                                                </span>
                                                <h6 class="post_title">
                                        ...
                                        <div class="related_item related_item_style_2">
                                            <div class="post_featured hover_icon copypress-post-related-post-2">
                                                <div class="mask"></div>
                                                <div class="icons">
                                                    <a href="post-single.html" aria-hidden="true" class="icon-eye-1"></a>
                                                </div>
                                    ...
                                    <ul class="comments_list">
                                        <li class="comment even thread-even depth-1 comment_item">
                                            <div class="comment_author_avatar">
                                                <img alt="" src="http://0.gravatar.com/avatar/9e531e09e6ec2f1c13f35a098a3ba002?s=90&#038;d=mm&#038;r=g" />
                                            </div>
                                            <div class="comment_content">
                                                <div class="comment_info">
                                                    <h5 class="comment_author">Miki Williams</h5>
                                                </div>
                                                <div class="comment_text_wrap">
                                                    <div class="comment_text">
                                                        <p>Thanks for the heads up and for the awesome pictures. Love your website and wish you good luck!</p>
                                                    </div>
                                                </div>
                                            ...
                                            <ul class="children">
                                                <li class="comment odd alt depth-2 comment_item">
                                                    <div class="comment_author_avatar">
                                                        <img alt="" src="http://2.gravatar.com/avatar/b00d707fa3ea25d46848698a8623f61b?s=90&#038;d=mm&#038;r=g" />
                                                    </div>
                                                    <div class="comment_content">
                                                        <div class="comment_info">
                                                            <h5 class="comment_author">Jhon Miller</h5>
                                                        </div>
                                                        <div class="comment_text_wrap">
                                                            <div class="comment_text">
                                                                <p>I definitely want one of these. I think your designs are the best for my project</p>
                                                            </div>
                                                        </div>
                                                        <div class="comment_reply">
                                                            <a class="comment-reply-link" href="#">Reply</a>
                                                    ...
                                                    <ul class="children">
                                                        <li class="comment bypostauthor even depth-3 comment_item">
                                                            <div class="comment_author_avatar">
                                                                <img alt="" src="http://2.gravatar.com/avatar/e64c7d89f26bd1972efa854d13d7dd61?s=90&#038;d=mm&#038;r=g" /></div>
                                                            <div class="comment_content">
                                                                <div class="comment_info">
                                                                    <h5 class="comment_author">Martin Moore<a href="#"></a></h5>
                                                                </div>
                                                                <div class="comment_text_wrap">
                                                                    <div class="comment_text">
                                                                        <p>Thanks! We love to hear from our clients!</p>
                                                                    </div>
                                                                </div>
                                                                <div class="comment_reply">
                                                                    <a class="comment-reply-link" href="#">Reply</a></div>
                                                            </div>
                                                        </li>
                                                    </ul>
                                                </li>
                                        ...
                                        <div id="respond" class="comment-respond">
                                            <form action="#" method="post" id="commentform" class="comment-form " novalidate>
                                                ...
                                                <div class="comments_field comments_author">
                                                    ...
                                                    <span class="sc_form_field_wrap">
                                                        <input id="author" name="author" type="text" placeholder="Your Name *" value="" aria-required="true" /></span>
                                                </div>
